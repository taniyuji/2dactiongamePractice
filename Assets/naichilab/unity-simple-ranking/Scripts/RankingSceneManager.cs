...
namespace naichilab
{
    public class RankingSceneManager : MonoBehaviour
    {
        ...
        public EndingSelectMenu esm;
        public LoadScenes LoadStage1;
        ...
        void Start()
        {
            try
            {
                esm = GameObject.Find("selectMenu").GetComponent<EndingSelectMenu>();
            }
            catch (System.NullReferenceException)
            {
                LoadStage1 = GameObject.Find("LoadStage1").GetComponent<LoadScenes>();
            }
...
//                    Debug.Log(r[COLUMN_SCORE].ToString());
        ...
        public void OnCloseButtonClick()
        {
            ...
            {
                esm.isset = false;
                esm.openRanking = false;
            }
            else
            {
                LoadStage1.isSet = false;
                LoadStage1.openRanking = false;
            }
